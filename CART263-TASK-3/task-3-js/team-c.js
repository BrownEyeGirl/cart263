...
function setup_C() {
  ...
  function aniB(parentCanvas) { // SKYLA 
...
// sun 
  ...
  /* sunlite (another layer to support the ) 
  sunlite.style.width = `10`+"px";
  sunlite.style.height = `10`+"px";
  ocean.style.position=`absolute`; 
  ocean.style.top=`50%`;
  ocean.style.left=`50%`; 
  //ocean.style.transform="translate(-50%, -50%)";
  ocean.style.boxShadow =
    '0 0 30px 20px #fff, ' +
    '0 0 140px 60px rgba(0, 255, 200, 1),' +
    '0 0 100px 30px rgba(255, 0, 191, 1)';
  ocean.style.border=`none`;
